...
import style from './BrandDe.module.css'
...
export default function BrandDe() {
    ...
    let nameBrand = name
    const filteredProducts = products?.filter((product) => product.brand?.name === nameBrand);
    if (isLoading) {
        return <Loading />
    }
    if (isError) {
        ...
        <div className='container mx-auto'>
            ...
            <div className='flex justify-between items-center'>
                ...
                <h2 className="text-2xl font-bold text-gray-800 mb-4">
                    Brand: <span className="text-[#dc2626]">{nameBrand}</span>
                </h2>
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 container mx-auto'>
                ...
                return (
                    ...
                    <div key={`${products.id}`} className="group flex flex-col bg-white border border-gray-200 rounded-xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 h-full">
                        ...
                        <div className="relative h-56 overflow-hidden bg-gray-100">
                            ...
                            <Link to={`/brandproducts/${products.brand._id}`}>
            ...
            {filteredProducts.length === 0 && (
                <div className="col-span-full text-center py-10">
                    <h3 className="text-xl font-bold text-gray-700 mb-4">No products found for this brand.</h3>
                </div>
            )}
        </div>
        <BrandSlider />
